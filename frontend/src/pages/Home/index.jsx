  ...
  return (
   <div className="min-h-screen flex flex-col">
      <div
        ...
        className="relative w-full h-[70svh] md:h-[85vh] bg-cover bg-center bg-no-repeat"
      >
        <div className="absolute inset-0 bg-black/40"></div>

    <div className="absolute top-4 right-4 sm:top-8 sm:right-8 flex flex-wrap justify-end gap-2 sm:gap-8 z-50">
          
         <button
            onClick={() => navigate("/login")}
            className="relative cursor-pointer min-w-[82px] sm:min-w-[90px] py-3 sm:py-4 px-5 sm:px-10 text-center inline-flex justify-center items-center text-base uppercase text-white rounded-lg transition-all duration-300 group overflow-hidden"
          >
          ...
          <button
            ...
            className="relative cursor-pointer min-w-[105px] sm:min-w-[120px] py-3 sm:py-4 px-5 sm:px-10 text-center inline-flex justify-center items-center text-base uppercase text-[#66ff66] rounded-lg transition-all duration-300 group overflow-hidden"
          >
